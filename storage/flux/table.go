...
func (t *floatEmptyWindowSelectorTable) newValuesArray(builder *array.Float64Builder) *array.Float64 {
...
func (t *integerEmptyWindowSelectorTable) newValuesArray(builder *array.Int64Builder) *array.Int64 {
...
func (t *unsignedEmptyWindowSelectorTable) newValuesArray(builder *array.Uint64Builder) *array.Uint64 {
	return builder.NewUint64Array()
}
...
func (t *stringEmptyWindowSelectorTable) newValuesArray(builder *array.BinaryBuilder) *array.Binary {
...
func (t *booleanEmptyWindowSelectorTable) newValuesArray(builder *array.BooleanBuilder) *array.Boolean {
